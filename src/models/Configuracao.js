...
const configuracaoSchema = new mongoose.Schema({
  ...
  crt:         { type: String, enum: ['1', '2', '3'], default: '1' },
  regimeTributario:   { type: String, default: '' },
  grupoTributario:    { type: String, default: '' },
  cnpjNFe:            { type: String, default: '' },
  serieNFCe:          { type: String, default: '001' },
  serieNFe:           { type: String, default: '001' },
  observacoesFiscais: { type: String, default: '' },
